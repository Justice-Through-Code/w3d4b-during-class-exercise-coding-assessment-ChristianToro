...
def main():
    ...
    if choice == 1:  #DO NOT REMOVE THE 'IF'
        ...
        radius = print('Please enter the radius of the circle:')
        ...
        length = print('Please enter the length of the rectangle:')
        width = print('Please enter the width of the rectangle:')
        ...
        base = print('Please enter the base length of the triangle:')
        height = print('Please enter the height of the triangle:')
